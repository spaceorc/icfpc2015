...
namespace SomeSecretProject.Tests
{
	...
	public class SpawnTest
	{
		...
		public void SmallBacteriaTest()
		{
			...
			var unit = new Unit { members = new[] { new Cell { x = 1, y = 1 } }, pivot = new Cell { x = 2, y = 2 } };
		...
		public void SinglePointTest_5()
		{
			...
			var unit = new Unit { members = new[] { new Cell { x = 5, y = 5 } }, pivot = new Cell { x = 5, y = 5 } };
		...
		public void LongVTest()
		{
			...
			Assert.AreEqual(new Cell { x = 1, y = 0 }, placedUnit.members[0]);
			Assert.AreEqual(new Cell { x = 1, y = 1 }, placedUnit.members[1]);
			Assert.AreEqual(new Cell { x = 2, y = 2 }, placedUnit.members[2]);
			Assert.AreEqual(new Cell { x = 2, y = 1 }, placedUnit.members[3]);
			Assert.AreEqual(new Cell { x = 3, y = 0 }, placedUnit.members[4]);
